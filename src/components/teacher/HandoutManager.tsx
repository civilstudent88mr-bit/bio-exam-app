...
export function HandoutManager() {
  ...
  const submit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      notify(error instanceof Error ? error.message : 'خطا در انتشار جزوه؛ تنظیمات Storage را بررسی کنید', 'error');
  ...
  return <div className="space-y-6 animate-fade-in">
    ...
    <div className="card"><h3 className="font-bold mb-4">جزوات من</h3>
